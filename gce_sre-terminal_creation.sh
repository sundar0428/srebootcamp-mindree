...
echo "Great!!! You are creating $instance_name with centos image"
...
gcloud compute instances create $instance_name --project=mindtree-training-sundar --zone=europe-west2-a --machine-type=f1-micro --network-interface=network-tier=PREMIUM,subnet=default --metadata=startup-script=\#\!\ /bin/bash$'\n'\ sudo\ yum\ install\ wget\ unzip\ -y$'\n'\ \#sudo\ yum\ update\ -y$'\n'\ sudo\ wget\ https://releases.hashicorp.com/terraform/1.1.7/terraform_1.1.7_linux_amd64.zip$'\n'\ sudo\ unzip\ terraform_1.1.7_linux_amd64.zip\ -d\ /usr/local/bin/ --maintenance-policy=MIGRATE --service-account=271738677308-compute@developer.gserviceaccount.com --scopes=https://www.googleapis.com/auth/devstorage.read_only,https://www.googleapis.com/auth/logging.write,https://www.googleapis.com/auth/monitoring.write,https://www.googleapis.com/auth/servicecontrol,https://www.googleapis.com/auth/service.management.readonly,https://www.googleapis.com/auth/trace.append --tags=http-server,https-server --create-disk=auto-delete=yes,boot=yes,device-name=instance-3,image=projects/centos-cloud/global/images/centos-7-v20220303,mode=rw,size=20,type=projects/mindtree-training-sundar/zones/europe-west2-a/diskTypes/pd-balanced --no-shielded-secure-boot --shielded-vtpm --shielded-integrity-monitoring --reservation-affinity=any
